          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-gray-600 mb-6">
                Have questions about our free AI attractiveness test? Need help understanding an analysis result? 
                We're here to help with your beauty analysis inquiries. Send us a message and we'll respond as soon as possible.
              </p>
              
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  <Sparkles className="h-5 w-5 text-gray-400" />
                  <a href="mailto:support@example.com" className="text-purple-500 hover:text-purple-700">
                    support@example.com
                  </a>
                </div>
                <div className="flex items-center gap-3">
